...
COPY . $CONTAINER_PATH
COPY ./magento2ee $CONTAINER_PATH
COPY ./magento2b2b $CONTAINER_PATH
# COPY ./magento2ce-sample-data $CONTAINER_PATH
# COPY ./magento2ee-sample-data $CONTAINER PATH
...
ENTRYPOINT ["supervisor", "/usr/local/bin/entrypoint.sh"]
